...
public class RealCachingRequestWrapper extends HttpServletRequestWrapper {
     ...
     */
    public RealCachingRequestWrapper(HttpServletRequest req) throws IOException {
        super(req);
        int contentLength = req.getContentLength();
        this.cachedContent = new ByteArrayOutputStream(contentLength >= 0 ? contentLength : 1024);
        this.contentCacheLimit = null;
        writeRequestParametersToCachedContent();
        data = req.getInputStream().readAllBytes();
    }
     ...
     * @since 4.3.6
     */
    public RealCachingRequestWrapper(HttpServletRequest req, int contentCacheLimit) throws IOException {
        super(req);
